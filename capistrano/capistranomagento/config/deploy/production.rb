...
### CUSTOM VARIABLE
set :http_domain, "production.magehackathon.local"
...
set :install_date, "Sat, 03 Mar 2013 14:36:42 +0000"
set :install_key, "aa3a600aadf56789op2c5b6c91e9876540"
...
set :google_analytics, 1
set :secure_admin, 1
set :secure_frontend, 1
set :dev_mailer, "my_prodcution_email@localhost.com"
set :magentodemo, 0
set :jscsscompression, 1